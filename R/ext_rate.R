...
# mu_P0: the initial extinction rate of plant species without mutualistic partners
...
# mu_par <- c(0.2,0.2,0.01,0.01)
# ext_list <- get_ext_rate(Mt,p_status,a_status,mutualism_pars)
